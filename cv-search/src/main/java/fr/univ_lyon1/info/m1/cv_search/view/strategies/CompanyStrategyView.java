...
public class CompanyStrategyView extends Observable {
    
    /**
     * Create the view for strategy.
     */
    public CompanyStrategyView(Stage stage, Integer width, Integer height, Strategy s) {
        addObserver(s);
        // Name of window
        stage.setTitle("Search for CV");

        VBox root = new VBox();
        Label labelStrategy = new Label("Company name: ");
        TextField textField = new TextField();
        Button submitButton = new Button("OK");
        submitButton.setOnAction(e -> {
            HashMap<String, Object> params = new HashMap<String, Object>();
            params.put("companyName", textField.getText().strip());
            change();
